Game Plan
[X] create UI mock-up / sketch
[X] outline components, state, what to pass through props
[X] outline database table(s?) structure
[X] create table(s)
[X] add some (seed) data
[ ] add API endpoint to show list of blog posts
...
